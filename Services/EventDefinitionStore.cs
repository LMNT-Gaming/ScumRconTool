...
public static class EventDefinitionStore
{
    ...
    public static EventDefinition CreateTemplate()
    {
        ...
        return new EventDefinition
        {
            ...
            LiveBlock = new ScriptBlock
            {
                ...
                Commands = new List<EventCommand>
                {
                    new() { Name = "Eventzone started", Command = "#Broadcast Red Eventzone started", DelayMs = 250 }
                }
            },
    ...
    private static EventDefinition BuildRandomC4BunkerScript() => new()
    {
        ...
        InitiatorBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                new() { Name = "C4 WWII Bunker Announcement", Command = "#Broadcast Yellow Npc activity in an C4 WWII Bunker", DelayMs = 250 }
            }
        },
        LiveBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                ...
                new() { Name = "Loot - Weapon SKS", Command = "#SpawnItem Weapon_SKS 1 Location \"[{X=577961.125 Y=115021.242 Z=5877.507|P=296.218018 Y=230.051529 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot - SKS Clips", Command = "#SpawnItem Magazine_Clip_SKS 2 Location \"[{X=577969.312 Y=115101.781 Z=5877.507|P=316.004181 Y=302.388977 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot - 7.62x39 Ammo Box", Command = "#SpawnItem Cal_7_62x39mm_Ammobox 2 Location \"[{X=577969.312 Y=115101.781 Z=5877.507|P=316.004181 Y=302.388977 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot - Copper Coins", Command = "#SpawnItem Copper_Coins 1 Location \"[{X=577969.312 Y=115101.781 Z=5877.507|P=316.004181 Y=302.388977 R=0.000000}]\"", DelayMs = 250 }
            }
        },
        EmptyBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                new() { Name = "C4 Bunker zone empty", Command = "#Broadcast Yellow C4 WWII Bunker eventzone is empty. Event cooldown started.", DelayMs = 250 }
            }
        },
        CleanupWhenEmptySeconds = 300,
        CooldownMinutes = 60
    ...
    private static EventDefinition BuildRandomA3CarCrashScript() => new()
    {
        ...
        InitiatorBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                new() { Name = "A3 Car Crash Announcement", Command = "#Broadcast Yellow Npc car crash in A3", DelayMs = 250 }
            }
        },
        LiveBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                ...
                new() { Name = "Loot A3 spot 1 - Weapon SKS", Command = "#SpawnItem Weapon_SKS 1 Location \"[{X=198002.219 Y=-348777.250 Z=14019.290|P=329.455322 Y=236.482391 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot A3 spot 2 - SKS Clips", Command = "#SpawnItem Magazine_Clip_SKS 2 Location \"[{X=197894.719 Y=-348745.594 Z=14034.636|P=338.161041 Y=250.728409 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot A3 spot 2 - 7.62x39 Ammo Box", Command = "#SpawnItem Cal_7_62x39mm_Ammobox 2 Location \"[{X=197894.719 Y=-348745.594 Z=14034.636|P=338.161041 Y=250.728409 R=0.000000}]\"", DelayMs = 250 },
                new() { Name = "Loot A3 spot 2 - Copper Coins", Command = "#SpawnItem Copper_Coins 1 Location \"[{X=197894.719 Y=-348745.594 Z=14034.636|P=338.161041 Y=250.728409 R=0.000000}]\"", DelayMs = 250 }
            }
        },
        EmptyBlock = new ScriptBlock
        {
            ...
            Commands = new List<EventCommand>
            {
                new() { Name = "A3 crash zone empty", Command = "#Broadcast Yellow A3 car crash eventzone is empty. Event cooldown started.", DelayMs = 250 }
            }
        },
        CleanupWhenEmptySeconds = 300,
        CooldownMinutes = 60
